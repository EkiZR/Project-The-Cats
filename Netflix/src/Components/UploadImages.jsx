...
function Gallery() {
	...
	const getUploadedImagesCount = () => {
		const userIP = getUserIp; // Ganti dengan alamat IP pengguna (gunakan library atau API untuk mendapatkan alamat IP pengguna)
		const uploadedImages = localStorage.getItem(userIP);
	  ...
	  const incrementUploadedImagesCount = () => {
		...
		localStorage.setItem(userIP, uploadedImages + 1);
	  };
	...
	return (
		<div>
			...
			<br />
			<b className="text-[48px] mt-0  text-white  pt-5 opacity-[90%] flex items-center justify-center border-t-[8px] border-[#232323] shadow-lg" id="Gallery">
				Gallery
			</b>
